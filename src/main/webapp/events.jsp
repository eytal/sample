                            ...
                            <div class="col-sm-10 my-auto mx-auto">
                                <div class="card bg-dark">
                                    ...
                                    <div class="card-body text-white">
                                        ...
                                        <p class="card-text">
                                            Enter the address of another Server Messenger to send a message to. The Messages window on the right will display the status of messages sent and received.
                                        </p>
                                        <div class="card-text">
                                            This Server's address is <span id="apiURL" class="bold"></span>
                                        </div>
                                    </div>
